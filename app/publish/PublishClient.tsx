              ...
              <tbody>
                {queue.map((post) => {
                  const charName =
                    ...
                    (post.chs_media as { chs_daily_plans?: { chs_characters?: { name?: string } } } | null)?.chs_daily_plans?.chs_characters?.name ??
                    "—";
                          ...
                          <div className="flex flex-col gap-1 items-start">
                            ...
                            {!!(post as Record<string, unknown>).last_error && (
                              <span className="font-mono text-[8px] text-red-400/70 max-w-[200px] break-words leading-snug">
                                {String((post as Record<string, unknown>).last_error).slice(0, 120)}
                              </span>
                            )}
                          </div>
                        ) : null}
